...
function App() {
  ...
  return (
    <UserContext.Provider value={{ users, setUsers, currentUser, setCurrentUser }}>
      <RecipesContext.Provider value={{ userRecipes, setRecipes }}>
        <Switch>
          <Route path="/add"> <AddRecipe onAddDrink={handleAddDrink} /> </Route>
          <Route path="/edit/:id"> <EditRecipe /> </Route>
          <Route path="/details/:id"> <RecipeDetails /> </Route>
          <Route path="/newuser"> <NewUser onNewUserSubmit={handleNewUserSubmit} /> </Route>
